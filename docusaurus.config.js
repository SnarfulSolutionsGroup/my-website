...
const config = {
  ...
  tagline: 'Because documentation never takes the day off',
  ...
  url: 'https://my-website-eoqj.onrender.com/',
  ...
  // If you aren't using GitHub pages, you don't need these.
   organizationName: '/SnarfulSolutionsGroup', // Usually your GitHub org/user name.
